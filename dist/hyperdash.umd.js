(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('rxjs'), require('rxjs/operators'), require('lodash-es'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'rxjs', 'rxjs/operators', 'lodash-es'], factory)
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory((global.hyperdash = {}), global.rxjs, global.rxjs.operators, global._));
})(this, function (exports, rxjs, operators, lodashEs) {
  'use strict';
  ...
  var DashboardEventManager = /** @class */ (function () {
    ...
    DashboardEventManager.prototype.getObservableForEvent = function (eventKey) {
      return this.eventSubject.pipe(
        operators.filter(function (keyedEvent) {
          return keyedEvent.key === eventKey;
        }),
        operators.map(function (keyedEvent) {
  ...
  ***************************************************************************** */
  ...
  var ModelDestroyedEvent = /** @class */ (function (_super) {
    ...
    ModelDestroyedEvent.prototype.getDestructionObservable = function (model) {
      return this.getObservable().pipe(
        operators.filter(function (destroyedModel) {
  ...
  var typeofValidator = function (type) {
    return function (value, allowUndefinedOrNull) {
      if (allowUndefinedOrNull && lodashEs.isNil(value)) {
        return undefined;
      }
  ...
  var UNKNOWN_PROPERTY = Object.freeze({
    ...
    validator: function (value, allowUndefinedOrNull) {
      if (lodashEs.isNil(value) && !allowUndefinedOrNull) {
        return 'Required property got ' + value + ' value';
      }
      return undefined;
    }
  ...
  var EditorLibrary = /** @class */ (function () {
    ...
    EditorLibrary.prototype.getEditorData = function (modelConstructor) {
      ...
      var compositeData = {
        ...
        kind: exports.EditorKind.Composite
      };
    ...
    EditorLibrary.prototype.getEditorMatchingModelClasses = function (
      ...
      var allMatchingEditors = this.getAllCompatibleModelClasses(modelClasses).map(function (compatibleConstructor) {
        return {
          ...
          kind: exports.EditorKind.Unresolved
        };
      });
  ...
  })(exports.EditorKind || (exports.EditorKind = {}));
  ...
  var ModelEventInstaller = /** @class */ (function () {
    ...
    ModelEventInstaller.prototype.installEventSubscriber = function (modelInstance, eventKey, propertyKey) {
      this.getObservableForModel(modelInstance, eventKey)
        .pipe(operators.takeUntil(this.modelDestroyedEvent.getDestructionObservable(modelInstance)))
    ...
    ModelEventInstaller.prototype.installEventPublisher = function (modelInstance, eventKey, propertyKey) {
      ...
      if (publisherPropertyValue instanceof rxjs.Observable) {
  ...
  var ModelManager = /** @class */ (function () {
    ...
    ModelManager.prototype.removeChildFromParent = function (parent, childToRemove) {
      ...
      var newParentData = __assign(__assign({}, originalParentData), {
        children: lodashEs.without(originalParentData.children, childToRemove)
      });
    ...
    ModelManager.prototype.getInstanceDataOrThrow = function (instance) {
      ...
      return lodashEs.cloneDeepWith(this.modelInstanceMap.get(instance), cloneFunction);
    };
  ...
  var ModelPropertyTypeLibrary = /** @class */ (function () {
    ...
    ModelPropertyTypeLibrary.prototype.convertPropertyTypeRegistrationInfoToMetadata = function (registrationInfo) {
      return {
        validator:
          this.bindPotentialFunction(registrationInfo, 'validator') || ModelPropertyTypeLibrary.NO_OP_VALIDATOR,
  ...
  */
  ...
  var ModelLibrary = /** @class */ (function () {
    ...
    ModelLibrary.prototype.convertPropertyRegistrationToMetadata = function (
      propertyKey,
      registrationInfo,
      modelClass
    ) {
      var registrationInfoWithConvertedType = __assign(__assign({}, registrationInfo), {
        type:
          typeof registrationInfo.type === 'string'
            ? { key: registrationInfo.type }
            : __assign({}, registrationInfo.type)
      });
      return lodashEs.defaults(registrationInfoWithConvertedType, {
    ...
    ModelLibrary.prototype.formatAsDisplayName = function (input) {
      return lodashEs.startCase(input);
    };
    return ModelLibrary;
  })();
  ...
  var ObjectDeserializer = /** @class */ (function () {
    ...
    ObjectDeserializer.prototype.deserialize = function (object, location) {
      ...
      return Object.assign(newObject, lodashEs.mapValues(object, deserializeModelValue));
    };
      ...
      this.modelLibrary.lookupModelProperties(modelClass).forEach(function (propMetdata) {
        ...
        try {
          var deserializedValue = _this.getDeserializationFunctionForProperty(propMetdata)(
            serializedValue,
            PropertyLocation.forModelProperty(instance, propMetdata.runtimeKey).withValidator(function (
              valueToValidate
            ) {
  ...
  var PrimitiveDeserializer = /** @class */ (function () {
    ...
    PrimitiveDeserializer.prototype.canDeserialize = function (json) {
      return json === null || lodashEs.includes(PrimitiveDeserializer.ALLOWED_PRIMITIVE_TYPES, typeof json);
    };
    /**
     * @inheritdoc
     */
  ...
  var ObjectSerializer = /** @class */ (function () {
    ...
    ObjectSerializer.prototype.serialize = function (sourceObject, location) {
      ...
      // tslint:disable-next-line:prefer-object-spread seems like a questionable rule, breaks behavior here
      return Object.assign(newObject, lodashEs.mapValues(sourceObject, serializeModelValue));
    };
  ...
  var PrimitiveSerializer = /** @class */ (function () {
    ...
    PrimitiveSerializer.prototype.canSerialize = function (value) {
      return value === null || lodashEs.includes(PrimitiveSerializer.ALLOWED_PRIMITIVE_TYPES, typeof value);
    };
    /**
     * @inheritdoc
     */
      ...
      this.parseRules = [
        {
          ...
          parsedUntil: function (endingIndex) {
            return lodashEs.min([endingIndex, _this.lastIndexOfLength(_this.expression.length)]);
          },
  ...
  var VariableEvaluator = /** @class */ (function () {
    ...
    VariableEvaluator.prototype.evaluate = function (dictionary) {
      ...
      result.variableNamesRemoved = lodashEs.difference(variablesBeforeEvaluate, variablesAfterEvaluate);
      result.variableNamesAdded = lodashEs.difference(variablesAfterEvaluate, variablesBeforeEvaluate);
      return result;
    };
    /**
    ...
    VariableEvaluator.prototype.convertExpressionToValue = function (node, dictionary) {
      ...
      var result = lodashEs.get(dictionary, propertyPath);
      if (result !== undefined) {
  ...
  var VariableManager = /** @class */ (function () {
    ...
    VariableManager.prototype.getVariableExpressionFromLocation = function (location) {
      ...
      if (!reference) {
        return this.logger
          .error(
            'Attempted to resolve reference at ' +
              location.toString() +
              ' which does not contain a registered reference'
          )
          .throw();
    ...
    VariableManager.prototype.getResolveDictionaryForModel = function (modelScope) {
      var variablePairs = [];
      var nextModelScope = this.variableDictionaries.has(modelScope)
        ? modelScope
        : this.getParentModelScope(modelScope);
    ...
    VariableManager.prototype.updateValueReferenceTrackingFromEvaluationResult = function (
      reference,
      evaluationResult
    ) {
      var _this = this;
  ...
  exports.ARRAY_PROPERTY = ARRAY_PROPERTY;
  exports.ArrayDeserializer = ArrayDeserializer;
  exports.ArraySerializer = ArraySerializer;
  exports.BOOLEAN_PROPERTY = BOOLEAN_PROPERTY;
  exports.BeforeModelDestroyedEvent = BeforeModelDestroyedEvent;
  ...
  exports.DataRefreshEvent = DataRefreshEvent;
  exports.DataSourceManager = DataSourceManager;
  exports.DefaultModelApiBuilder = DefaultModelApiBuilder;
  exports.DeserializationManager = DeserializationManager;
  exports.EditorApiFactory = EditorApiFactory;
  exports.EditorLibrary = EditorLibrary;
  exports.Logger = Logger;
  exports.Model = Model;
  exports.ModelChangedEvent = ModelChangedEvent;
  exports.ModelCreatedEvent = ModelCreatedEvent;
  exports.ModelDeserializer = ModelDeserializer;
  exports.ModelDestroyedEvent = ModelDestroyedEvent;
  exports.ModelEventInstaller = ModelEventInstaller;
  ...
  exports.ModelPropertyEditor = ModelPropertyEditor;
  exports.ModelPropertyType = ModelPropertyType;
  exports.ModelPropertyTypeLibrary = ModelPropertyTypeLibrary;
  exports.ModelPropertyValidator = ModelPropertyValidator;
  exports.ModelScopedDashboardEvent = ModelScopedDashboardEvent;
  exports.ModelSerializer = ModelSerializer;
  exports.NUMBER_PROPERTY = NUMBER_PROPERTY;
  exports.ObjectDeserializer = ObjectDeserializer;
  exports.ObjectSerializer = ObjectSerializer;
  exports.PLAIN_OBJECT_PROPERTY = PLAIN_OBJECT_PROPERTY;
  exports.PrimitiveDeserializer = PrimitiveDeserializer;
  exports.PrimitiveSerializer = PrimitiveSerializer;
  exports.PropertyLocation = PropertyLocation;
  exports.Renderer = Renderer;
  exports.RendererLibrary = RendererLibrary;
  exports.STRING_PROPERTY = STRING_PROPERTY;
  exports.SerializationManager = SerializationManager;
  exports.Theme = Theme;
  exports.ThemeManager = ThemeManager;
  exports.TimeRangeChangedEvent = TimeRangeChangedEvent;
  exports.TimeRangeManager = TimeRangeManager;
  exports.UNKNOWN_PROPERTY = UNKNOWN_PROPERTY;
  exports.VariableDeserializer = VariableDeserializer;
  exports.VariableManager = VariableManager;
  exports.VariableSerializer = VariableSerializer;
  exports.beforeModelDestroyedEventKey = beforeModelDestroyedEventKey;
  exports.dataRefreshEventKey = dataRefreshEventKey;
  exports.dataSourceMarker = dataSourceMarker;
  exports.modelCreatedEventKey = modelCreatedEventKey;
  exports.modelDestroyedEventKey = modelDestroyedEventKey;

  Object.defineProperty(exports, '__esModule', { value: true });
});
//# sourceMappingURL=hyperdash.umd.js.map
